...
// Select
$outerQuery="SELECT serialID,countryID,compressorID FROM serial WHERE serialID like '$serialID' AND countryID like '$countryID' AND compressorID like '$compressorID' AND WHERE serialID NOT IN (SELECT DISTINCT(serialID) FROM billRow)";
