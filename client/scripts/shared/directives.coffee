            ...
            ($scope, $element, $location) ->
                ...
                addBg = (path) ->
                    ...
                    switch path
                        ...
                        when '/404', '/pages/500', '/pages/signin', '/pages/signup', '/pages/forgot', '/accounts/signIn','/landing/uno','/landing/dos','/landing', '/accounts/signUp', '/accounts/retailerRequest', '/roy/code', '/accounts/password-reset' then $element.addClass('body-special')
